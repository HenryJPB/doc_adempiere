...
sudo docker volume create --name postgresql-db
...
( en accion 👇 ) 
sudo docker run --rm -it -v f04da1868590c6d646808abd7817454d4e428d41a0c87dd4ddcaab65285ef440:/from -v postgresql-db:/to alpine ash -c 'cd /from ; cp -av . /to'
